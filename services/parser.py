...
COUNTRIES = [
    ...
    ("Pakistan", "PAK", ["pakistan"]), ("Bangladesh", "BGD", ["bangladesh"]),
    ("Nigeria", "NGA", ["nigeria"]), ("Vietnam", "VNM", ["vietnam", "viet nam"]),
    ("Philippines", "PHL", ["philippines"]), ("Kenya", "KEN", ["kenya"]),
    ("South Africa", "ZAF", ["south africa"]), ("Egypt", "EGY", ["egypt"]),
    ("Turkey", "TUR", ["turkey", "turkiye", "türkiye"]), ("Italy", "ITA", ["italy"]),
    ("Spain", "ESP", ["spain"]), ("Netherlands", "NLD", ["netherlands", "holland"]),
    ("Switzerland", "CHE", ["switzerland"]), ("Sweden", "SWE", ["sweden"]),
    ("Norway", "NOR", ["norway"]), ("Denmark", "DNK", ["denmark"]),
    ("Poland", "POL", ["poland"]), ("Mexico", "MEX", ["mexico"]),
    ("Argentina", "ARG", ["argentina"]), ("Chile", "CHL", ["chile"]),
    ("Colombia", "COL", ["colombia"]), ("Peru", "PER", ["peru"]),
    ("New Zealand", "NZL", ["new zealand"]), ("Ireland", "IRL", ["ireland"]),
    ("Israel", "ISR", ["israel"]), ("Iran", "IRN", ["iran"]),
    ("Iraq", "IRQ", ["iraq"]), ("Kuwait", "KWT", ["kuwait"]),
    ("Oman", "OMN", ["oman"]), ("Bahrain", "BHR", ["bahrain"]),
    ("Nepal", "NPL", ["nepal"]), ("Sri Lanka", "LKA", ["sri lanka"]),
    ("Afghanistan", "AFG", ["afghanistan"]), ("Kazakhstan", "KAZ", ["kazakhstan"]),
    ("Ukraine", "UKR", ["ukraine"]), ("Portugal", "PRT", ["portugal"]),
    ("Greece", "GRC", ["greece"]), ("Austria", "AUT", ["austria"]),
    ("Belgium", "BEL", ["belgium"]), ("Czech Republic", "CZE", ["czech republic", "czechia"]),
    ("Romania", "ROU", ["romania"]), ("Hungary", "HUN", ["hungary"]),
    ("Morocco", "MAR", ["morocco"]), ("Algeria", "DZA", ["algeria"]),
    ("Ethiopia", "ETH", ["ethiopia"]), ("Ghana", "GHA", ["ghana"]),
    ("Tanzania", "TZA", ["tanzania"]), ("Uganda", "UGA", ["uganda"]),
    ("Hong Kong", "HKG", ["hong kong"]), ("Taiwan", "TWN", ["taiwan"]),
]
